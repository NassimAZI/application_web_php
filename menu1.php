...
<li class="site-name">&nbsp;</li>
    <li class="yahoo"><a href="index.php"><strong>Accueil</strong></a>
    </li> 
    <li class="facebook"><a href="#"><strong>Annonces</strong></a>
        <ul>
        <li><a href="listeannonceP.php"><strong>Appels</strong></a></li>
        <li><a href="listeannonceP1.php"><strong>Informations</strong></a></li>
		<li><a href="listeannonceP2.php"><strong>Décés</strong></a></li>
        </ul>
    </li>
    <li class="google"><a href="forum.php"><strong>forum</strong></a>
    </li>
    <li class="twitter"><a href="connexion.php"><strong>Connexion</strong></a>
    </li>
