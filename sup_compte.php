...
function verification($nume){
				...
				$results=$bdd->query("SELECT count(*) as nbres FROM utilisateurs WHERE IdUtilisateur LIKE '$num_sql'");				
...
$req = $bdd->prepare("DELETE FROM utilisateurs WHERE IdUtilisateur LIKE :qt ");
$req->execute(array(
