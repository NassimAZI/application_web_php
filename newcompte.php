...
if(htmlspecialchars($_POST['nom'])!="" and htmlspecialchars($_POST['prenom'])!="" and htmlspecialchars($_POST['datenaissance'])!="" and htmlspecialchars($_POST['identifiant'])!="" and htmlspecialchars($_POST['motdepasse'])!="")
{
	if($_POST['choix']=="hm")
	{
	$sx='Homme';
...
$req-> execute(array(htmlspecialchars($_POST['nom']), htmlspecialchars($_POST['prenom']),htmlspecialchars($_POST['datenaissance']),htmlspecialchars($_POST['identifiant']),SHA1(htmlspecialchars($_POST['motdepasse'])),htmlspecialchars($sx),htmlspecialchars($sf),htmlspecialchars($sp)));
?>
