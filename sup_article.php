...
<section id="container">	
		...
		<div id="wrapping" class="clearfix">
			...
			<input type="text" name="identifiant2" id="identifiant2" placeholder="Entrez le nom de l'article" autocomplete="off" tabindex="1" class="txtinput">
			</section>		
		</div>
		<section id="buttons">
...
{	
$req = $bdd->prepare("DELETE FROM article WHERE NomArticle LIKE :qt ");
$req->execute(array(
