...
?>
		...
		<div id="wrapping" class="clearfix">
			...
			<h3>Mot de passe:</h3>
			<span class="chyron"><em><a href="modif_compte_ut.php">Changer</a></em></span>
			<input type="text" name="motdepasse" id="motdepasse" placeholder="MOT DE PASSE" autocomplete="off"  tabindex="4" class="txtinput" disabled />
			<h3>Date de naissance:</h3>
			<input type="date" name="datenaissance" id="date" placeholder="aaaa/mm/jj" autocomplete="off" tabindex="5" class="txtinput"value="<?php echo htmlspecialchars($dt);?>" disabled />		
			</section>		
