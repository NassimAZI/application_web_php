...
$reponse = $bdd->query("SELECT Idannonces, Titre,Contenu, DATE_FORMAT(Date, '%d/%m/%Y %Hh%imin') AS Date FROM annonces WHERE type LIKE 'Information' ORDER BY Idannonces DESC");
